package com.mcndsj.Bw_lobby.KitSystem;

import org.bukkit.ChatColor;
import org.bukkit.Material;
import org.bukkit.inventory.*;
import com.mcndsj.Bw_lobby.Utils.ItemFactory;
 ...
 */
public enum KitType {
    cook(200,4000,ItemFactory.create(Material.PORK,(byte)0, ChatColor.WHITE + "厨师",
            "衣食无忧,天下太平."),"cook",SkillType.Cook_1,SkillType.Cook_4,SkillType.Cook_6,SkillType.Cook_8),
    archer(200,4000,ItemFactory.create(Material.BOW,(byte)0,ChatColor.WHITE + "弓箭手",
            "以睹余物，皆丘山也."),"archer",SkillType.Archer_1,SkillType.Archer_4,SkillType.Archer_6,SkillType.Archer_8),
    assassin(200,4000,ItemFactory.create(Material.DIAMOND_SWORD,(byte)0,ChatColor.WHITE + "刺客",
            "十步杀一人,千里不留情."),"assassin",SkillType.Assassin_1,SkillType.Assassin_4,SkillType.Assassin_6,SkillType.Assassin_8),
    enderman(200,4000,ItemFactory.create(Material.ENDER_PORTAL_FRAME,(byte)0,ChatColor.WHITE + "末影使者",
            "掌控世间粒子的运动规则."),"enderman",SkillType.Enderman_1,SkillType.Enderman_4,SkillType.Enderman_6,SkillType.Enderman_8),
    bloodSeeker(200,4000,ItemFactory.create(Material.RED_ROSE,(byte)0, ChatColor.WHITE + "嗜血者",
